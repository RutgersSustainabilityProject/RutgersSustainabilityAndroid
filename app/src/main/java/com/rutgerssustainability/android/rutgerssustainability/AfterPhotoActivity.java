                    ...
                    transferObserver.setTransferListener(new TransferListener() {
                        ...
                        public void onStateChanged(final int id, final TransferState state) {
                            ...
                            if (state == TransferState.COMPLETED) {
                                ...
                                final MultipartBody.Part userIdPart = MultipartBody.Part.createFormData("userId", mDeviceId);
                                final MultipartBody.Part latitudePart = MultipartBody.Part.createFormData("latitude", String.valueOf(mLastLocation.getLatitude()));
                                final MultipartBody.Part longitudePart = MultipartBody.Part.createFormData("longitude", String.valueOf(mLastLocation.getLongitude()));
                                long epoch = System.currentTimeMillis();
                                final MultipartBody.Part epochPart = MultipartBody.Part.createFormData("epoch", String.valueOf(epoch));
                                final MultipartBody.Part tagsPart = MultipartBody.Part.createFormData("tags", newTags);
